...
public class Const {
    ...
    public static interface TitleFramesAndDlgs {
        String REGISTRATION_FRAME = "Rejestracja klientów";
    }

    public static interface ButtonLbls {
        String BTN_SAVE = "Zapisz";
        String BTN_CANCEL = "Anuluj";
    ...
    public static interface Strings {
        String NAME_REQUIRED = "Musisz podać imię i nazwisko żeby móc wyszukać klienta";
        String ROW_DELETE_REQUIRED = "Musisz wybrać wiersz który chcesz usunąć";
        String INFORMATION = "Informacja";
        String NAME_AND_SURNAME_REQUIRED = "Pole imie i nazwisko musi być uzupełnione";
    }
}